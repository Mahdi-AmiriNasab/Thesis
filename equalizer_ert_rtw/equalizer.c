...
void equalizer_step(void)
{
...

    {
        ...
        if (rtmIsMajorTimeStep(equalizer_M))
        {
            ...
            if (y)
            {
                ...
                y = (boolean_T)!(int16_T)equalizer_B.Memory4;
                if (((int16_T)equalizer_DW.dir == -1) && ((int16_T)y))
                {
                    equalizer_B.I_tranfer = equalizer_B.Memory3[(int16_T)
                        equalizer_U.src_q_cls[0] - 1];
                    equalizer_DW.enable = 1.0;
                    equalizer_DW.dir = (int8_T)0;
                }

                if ((int16_T)equalizer_DW.dir == 0)
                {
                    equalizer_B.I_tranfer = equalizer_B.Memory3[(int16_T)
                        equalizer_U.src_q_cls[0] - 1];
                }

                if (((int16_T)equalizer_DW.dir == 0) && ((int16_T)
                        equalizer_B.Memory4) && (equalizer_DW.enable == 1.0))
                {
                    equalizer_DW.enable = 0.0;
                }

                if (((int16_T)equalizer_DW.dir == 0) && ((int16_T)y) &&
                        (equalizer_DW.enable == 0.0))
                {
                    equalizer_B.I_tranfer = equalizer_B.Memory3[(int16_T)
                        equalizer_U.dst_q_cls[0] - 1];
                    equalizer_DW.enable = 1.0;
                    equalizer_DW.dir = (int8_T)1;
                }

                if ((int16_T)equalizer_DW.dir == 1)
                {
                    equalizer_B.I_tranfer = equalizer_B.Memory3[(int16_T)
                        equalizer_U.dst_q_cls[0] - 1];
                }

                if (((int16_T)equalizer_DW.dir == 1) && ((int16_T)
                        equalizer_B.Memory4) && (equalizer_DW.enable == 1.0))
                {
                    equalizer_DW.enable = 0.0;
                }
                ...
                if (((AH_coeff / (real_T)i <= equalizer_U.src_trg_soc_av) ||
                        (source_batt_number / (real_T)eq_current_tmp >=
                         equalizer_U.dst_trg_soc_av)) && ((int16_T)
                        equalizer_DW.dir == -1))
                {
             ...
             */
            equalizer_Y.sw_pos = (uint8_T)0U;

            /* Outport: '<Root>/sw_neg' incorporates:
             *  MATLAB Function: '<S1>/battery_selector'
             */
            equalizer_Y.sw_neg = (uint8_T)0U;
                    ...
                    (equalizer_B.Memory1[0] <= equalizer_B.Memory1[1]))
            {
                 ...
                 *  Outport: '<Root>/dir'
                 */
                equalizer_Y.eq_current = (real_T)eq_current_tmp;
            }

            /* DataTypeConversion: '<S1>/Data Type Conversion' incorporates:
             *  Inport: '<Root>/current_sensor_pb_ADC'
             */
            equalizer_B.DataTypeConversion = (real32_T)
                equalizer_U.current_sensor_pb_ADC;

            /* Outport: '<Root>/current_sensor_pb_Iout' incorporates:
             *  DataTypeConversion: '<S1>/Data Type Conversion'
             *  Lookup_n-D: '<S1>/1-D Lookup Table'
             */
            equalizer_Y.current_sensor_pb_Iout = look1_iflf_binlxpw
                (equalizer_B.DataTypeConversion,
                 equalizer_ConstP.uDLookupTable_bp01Data,
                 equalizer_ConstP.uDLookupTable_tableData, 2UL);
            ...
            if (equalizer_B.enable_I_trs > 0.0)
            {
                 ...
                 */
                AH_coeff = 1.0;
                source_batt_number = (equalizer_B.Memory1[1] -
                                      equalizer_B.Memory1[0]) + 1.0;
                destination_batt_number = (equalizer_B.Memory[1] -
                    equalizer_B.Memory[0]) + 1.0;
                if (source_batt_number > destination_batt_number)
                {
                    if ((int16_T)equalizer_Y.dir == 0)
                    {
                        AH_coeff = destination_batt_number / source_batt_number;
                    }
                }
                else if ((source_batt_number < destination_batt_number) &&
                         ((int16_T)equalizer_Y.dir == 1))
                {
        ...
        if (rtsiIsModeUpdateTimeStep(&equalizer_M->solverInfo))
        {
            ...
            y = (boolean_T)(zcEvent != NO_ZCEVENT);
        ...
        equalizer_B.comparator = (boolean_T)(equalizer_B.Integrator >=
            equalizer_B.Abs1);
    }
    ...
    if (rtmIsMajorTimeStep(equalizer_M))
    {
        ...
        if (rtmIsMajorTimeStep(equalizer_M))
        {
            ...
            equalizer_DW.Memory_PreviousInput[0] =
                equalizer_B.destinations_batts[0];

            /* Update for Memory: '<S1>/Memory1' */
            equalizer_DW.Memory1_PreviousInput[0] = equalizer_B.source_batts[0];

            /* Update for Memory: '<S1>/Memory' */
            equalizer_DW.Memory_PreviousInput[1] =
                equalizer_B.destinations_batts[1];
    ...
    if (rtmIsMajorTimeStep(equalizer_M))
    {
        ...
        equalizer_M->Timing.t[0] = rtsiGetSolverStopTime
            (&equalizer_M->solverInfo);
...
void equalizer_initialize(void)
{
    /* Registration code */
    {
        ...
        rtsiSetStepSizePtr(&equalizer_M->solverInfo,
                           &equalizer_M->Timing.stepSize0);
