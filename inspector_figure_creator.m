...
markerInterval = 2500; % Plot markers at every 100th data point

% Plot SOC
figure;
hold on;
for i = 1:9
    plot(soc_ts.Time, squeeze(soc_ts.Data(1,i,:)), 'LineWidth', line_width, ...
        'LineStyle', lineStyles{i}, 'Marker', markers{i}, 'Color', colors(i,:), ...
        'MarkerIndices', 1:markerInterval:length(soc_ts.Time));
end
