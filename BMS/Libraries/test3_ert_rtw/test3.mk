###########################################################################
## Makefile generated for component 'test3'. 
## 
## Makefile     : test3.mk
## Generated on : Mon May 15 09:33:03 2023
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test3.out
...
START_DIR                 = C:/Users/guest-ebadifard/Desktop/test3
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test3.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test3_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=test3 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/test3_ert_rtw/RCTcc.c $(START_DIR)/test3_ert_rtw/rtGetInf.c $(START_DIR)/test3_ert_rtw/rtGetNaN.c $(START_DIR)/test3_ert_rtw/rt_nonfinite.c $(START_DIR)/test3_ert_rtw/test3.c $(START_DIR)/test3_ert_rtw/test3_data.c
...
OBJS = RCTcc.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj test3.obj test3_data.obj
...
%.obj : $(START_DIR)/test3_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/test3_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/test3_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/test3_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
RCTcc.obj : $(START_DIR)/test3_ert_rtw/RCTcc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetInf.obj : $(START_DIR)/test3_ert_rtw/rtGetInf.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtGetNaN.obj : $(START_DIR)/test3_ert_rtw/rtGetNaN.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rt_nonfinite.obj : $(START_DIR)/test3_ert_rtw/rt_nonfinite.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


test3.obj : $(START_DIR)/test3_ert_rtw/test3.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


test3_data.obj : $(START_DIR)/test3_ert_rtw/test3_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
