...
# 11 "C:\\Program Files\\Microchip\\xc8\\v2.32\\pic\\include\\c99\\math.h" 2 3
...
# 785 "CAN/CAN.c"
  {
    ...
    if ((8 == CAN_U.balance1.Length) && (CAN_U.balance1.ID != 0xFFFFFFFFU) )
    {
      if ((0 == CAN_U.balance1.ID) && (0U == CAN_U.balance1.Extended) ) {
        {
# 799 "CAN/CAN.c"
          {
            uint16_T outValue = 0;
...
# 941 "CAN/CAN.c"
...

  {
    ...
    if ((8 == CAN_U.balance2.Length) && (CAN_U.balance2.ID != 0xFFFFFFFFU) )
    {
      if ((1 == CAN_U.balance2.ID) && (0U == CAN_U.balance2.Extended) ) {
        {
# 992 "CAN/CAN.c"
          {
            uint16_T outValue = 0;
