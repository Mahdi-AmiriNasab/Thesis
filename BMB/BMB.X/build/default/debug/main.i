...
uint8_t CAN_receive(uCAN_MSG *tempCanMsg,uCAN_MSG *tempCanMsg1);
...
typedef struct {
  int_T CANPack_ModeSignalID;
  int_T CANPack1_ModeSignalID;
  int_T CANPack2_ModeSignalID;
  int_T CANUnpack_ModeSignalID;
  int_T CANUnpack_StatusPortID;
  int_T CANUnpack1_ModeSignalID;
  int_T CANUnpack1_StatusPortID;
} DW_CAN_T;
...
typedef struct {
  ...
  uint16_T t2;
  uint16_T counter;
  CAN_MESSAGE_BUS balance2;
  CAN_MESSAGE_BUS balance1;
} ExtU_CAN_T;


typedef struct {
  CAN_MESSAGE_BUS Voltage1;
  CAN_MESSAGE_BUS Voltage2;
  CAN_MESSAGE_BUS Voltage3;
  uint16_T b1;
  uint16_T b2;
  uint16_T b3;
  uint16_T b4;
...
# 48 "main.c" 2
# 84 "main.c"
_Bool LTCBusyFlag, dataReadyFlag,LTCPermit,CANPermit,SPIError,CANRecError,LTCError;
...
# 386 "main.c"
    ...
    LTC681x_rdaux(0, TOTAL_IC, bmb_ic);
...
uint8_t getCellVoltage(){
    ...
    LTC681x_adcv(2,0,0);
    _delay((unsigned long)((1)*(8000000/4000.0)));
    LTC681x_rdcv(0, TOTAL_IC, bmb_ic);
