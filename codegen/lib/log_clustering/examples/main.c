...
#include "log_clustering_terminate.h"
...
static void main_log_clustering(void);
...
//   Call the entry-point 'pso'.
//   pso(soc, 2, 0.5, 0.5, 0, &global_best, &eq_step, &stio);
log_clustering(soc, 2, eps, &lg_time, &lg_inconsistency, &lg_eq_overlap);
